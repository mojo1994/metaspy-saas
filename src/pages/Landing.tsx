...
const PRICE_ROWS = [
  ...
  },
  {
    ...
    current: 'R$ 97,00',
    features: [
      ['Minerador de Anúncios + Editor Visual', true],
      ['Hospedar Páginas (PageVault)', true],
      ['Cloacker Premium (15 ferramentas)', true],
      ['Removedor de Metadados (EXIF)', true],
      ['Bypass Engines Multi-linguagem', true],
