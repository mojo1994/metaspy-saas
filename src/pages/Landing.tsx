...
const PRICE_ROWS = [
  ...
  },
  {
    ...
    features: [
      ['Minerador de Anúncios', true],
      ['Clonador', true],
      ['Hospedar 50 páginas/mês', true],
      ['Cloacker Premium', true],
      ['  • Gerador de Scripts', true],
      ['  • Script Avançado', true],
      ['  • Detector de Cloacking', true],
      ['  • Camuflagem de Texto', true],
      ['  • Camuflagem de Mídia', true],
      ['  • Campanhas', true],
      ['  • Links Assinados', true],
      ['  • Esteganografia', true],
      ['  • Logs em Tempo Real', true],
      ['  • Bypass Engines', true],
      ['Removedor de Metadados', true],
