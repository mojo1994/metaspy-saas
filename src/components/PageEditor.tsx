...
export default function PageEditor({ html, sourceUrl, onExtract }: PageEditorProps) {
  ...
  function parseCssValue(val: string): string {
    return val || '0px'
  }
        ...
        {editMode && showWidgets && (
          <div className="pe-widgets-panel">
            <div className="pe-sidebar-header">
              ...
              <button className="btn btn-secondary" onClick={() => setShowWidgets(false)} style={{ padding: '2px 8px', fontSize: 11 }}>✕</button>
            </div>
          ...
          <div className="pe-file-tree-panel">
            <div className="pe-file-tree-header">
              ...
              <div style={{ display: 'flex', gap: 4 }}>
                ...
                <button className="btn btn-secondary" onClick={() => setShowFileTree(false)} style={{ padding: '2px 8px', fontSize: 11 }}>✕</button>
              </div>
            </div>
